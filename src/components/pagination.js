...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    // TODO: DONE #2.3 — подготовить шаблон кнопки для страницы и очистить контейнер
    ...
    return (data, state, action) => {
        // TODO: DONE #2.1 — посчитать количество страниц, объявить переменные и константы
        ...
        // TODO: DONE #2.6 — обработать действия
        ...
        // TODO: DONE #2.4 — получить список видимых страниц и вывести их
        ...
        // TODO: DONE #2.5 — обновить статус пагинации
        ...
        // TODO: DONE #2.2 — посчитать сколько строк нужно пропустить и получить срез данных
